...
$if(email)$
% Phone and email
\vspace{$section-spacing$}
$phone$\\
\href{mailto:$email$}{$email$}\\[$content-spacing$]
${else}
% Only phone
\vspace{$section-spacing$}
$phone$\\
...
\vspace{[$content-spacing$]} % extra space below about list spacing
...
\emph{$experience.job$}\\
$experience.city$\\[$section-spacing$]
$endfor$
$endif$
...
\emph{$opensource.description$}\\[$section-spacing$]
$endfor$
$endif$
...
\emph{$extra.description$}\\[$section-spacing$]
$endfor$
$endif$
