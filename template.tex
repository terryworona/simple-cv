...
\definecolor{background}{rgb}{$backgroundred$, $backgroundgreen$, $backgroundblue$}
...
\emph{$education.institute$}$if(education.city)$, $education.city$$endif$\\[.5cm]
$endfor$
$endif$
...
\emph{$opensource.description$}\\[.5cm]
$endfor$
$endif$
